            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" id="registerationform" action="login.action" method="post">
                            <div class="text-center">
                                <img src="/traveler/resources/images/auth/logo-dark.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="text" id="memberId" name="memberId" class="form-control" placeholder="Your ID">
...
<![endif]-->
    ...
    <!-- Required Jquery -->
    <jsp:include page="/WEB-INF/views/modules/common-js.jsp"/></body>
